...
class SpotSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Spot::create(
            [
               'id_user' => 1,'xpos' => '105.8', 'ypos' => '-37.5', 'kunci_judul' => 'title_spot_9','kunci_teaser' => 'teaser_spot_9', 'url_media' => ["spots/waterblow4.jpg", "spots/waterblow5.jpg", "spots/waterblow6.jpg", "spots/waterblow1.jpg", "spots/waterblow2.jpg"], 'kunci_catatan' => 'note_spot_9', 'kunci_keterangan' => 'description_spot_9', 'alt_gambar' => 'Image for Waterblow', 'tampilkan_modal' => '1'
            ]
        );
        // Toilet 1
        Spot::create(
