<div x-data="{ focused:false }" id="search_box" :class="focused ? 'outline-3 outline-color-accent/50' : ''" class="relative flex bg-light-primary/5 w-fit items-center pl-3 rounded-xl p-2 gap-2 dark:bg-dark-primary/7">
