<div x-cloak x-show="openMapPopup" x-transition:enter="transition ease-in-out duration-100"
    ...
    $watch("openMapPopup", value => { reset(runInterval) })'
        ...
        <div class="flex flex-col md:flex-row">
            ...
            <button @click="openMapPopup = false, disableScrollOnBody(false)"
                class="!hidden btn-primary px-4 py-2 ml-auto cursor-pointer md:!flex">
        ...
        <div id="modalContent" class="flex flex-col p-2 overflow-y-auto max-h-[560px] gap-3 lg:flex-row lg:mt-5"
            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="infobox-accent p-5 gap-3 !w-full">
                    <x-local-icon icon="info" class="text-color-accent w-fit min-w-[20px] max-w-[24px]"
            ...
            <button @click="openMapPopup = false, disableScrollOnBody(false)"
                class="btn-primary mt-2 items-center justify-center w-full px-4 py-4 ml-auto cursor-pointer md:!hidden">
                <x-local-icon icon="x-cross" width="16px" height="16px" viewBox="0 0 200 200" fill="currentColor"
                    stroke="currentColor" xmlns="http://www.w3.org/2000/svg"></x-local-icon>
                <p>Close</p>
            </button>
