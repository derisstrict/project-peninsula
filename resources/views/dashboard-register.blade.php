...
<body class="bg-gray-50 dark:bg-gray-900">
    ...
    <section class="flex flex-col items-center justify-center px-6 py-8 mx-auto min-h-screen lg:py-0">
        <!-- Logo -->
            ...
            <div class="p-6 space-y-6 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-6" action="#" method="POST">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="terms" class="font-light text-gray-500 dark:text-gray-300">
                                I accept the 
                                <a href="#" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Terms and Conditions</a>
                            </label>
                        </div>
                    </div>
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400 text-center">
                        ...
                        <a href="dashboard-login" class="font-medium text-primary-600 hover:underline dark:text-primary-500">
                            Sign in
                        </a>
                    </p>
                </form>
