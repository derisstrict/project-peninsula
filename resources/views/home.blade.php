...
<div class="relative flex flex-col max-w-4xl gap-8">
    ...
    <div class="relative flex flex-col">
        ...
        <div class="flex flex-col justify-between xl:flex-row xl:items-center">
            ...
            <a href="/" class="btn-primary p-4 mt-5 self-center w-fit md:mt-5">
                <x-icon icon="google-maps" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px"
                    viewBox="0 0 48 48"></x-icon>
                <span class="text-sm">Take me to Google Maps</span>
                <x-icon icon="external-link" width="16px" height="16px" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" xmlns="http://www.w3.org/2000/svg"></x-icon>
            </a>
        </div>
        <div class="background-radial-blur transform -translate-y-25"></div>
        ...
        <div class="relative w-full h-[40rem] mt-10 mx-auto mb-32 overflow-hidden rounded-2xl shadow-lg bg-gray-200">
            <div id="map" class="w-full h-full cursor-grab active:cursor-grabbing" onmousedown="return false">
                <script>
                    // Fungsi initMap() akan dipanggil otomatis oleh Google Maps API
                    function initMap() {
                        const lokasi = {
                            lat: -8.8024627,
                            lng: 115.2379583
                        ...
                        new google.maps.Marker({
                            position: lokasi,
                            map: map,
                            title: "Garden of Hope, Peninsula Island 🌺",
                        });
                    }
                </script>
                ...
                <!-- API Google Maps -->
                <script async
                    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDLVx662tBmsOjD-QJMElbMe5OZbxX6V_4&callback=initMap"></script>
            </div>
        </div>
        <!-- /Google Maps -->
    ...
    <div>
        ...
        <p class="mt-6 max-w-4xl text-xl text-center mx-auto">
            Let's make your free time more meaningful! Here are five easy activity ideas you can do alone or with loved ones
            to recharge your batteries and improve your quality of life.
        </p>
    </div>
    ...
    <div class="grid grid-cols-2 gap-6 mt-6">
        <div class="infobox-accent">
            <div class="m-4">
                <x-icon class="text-lime-600" icon="jogging" width="45" height="45" viewBox="0 0 45 45"
                    fill="currentColor" xmlns="http://www.w3.org/2000/svg"></x-icon>
                ...
                <p class="mt-2">Improve your heart health and endurance with morning jogging.
                    ...
                    but it's also a highly effective way to start the day with high energy, clear your mind, and improve
                    mental focus.</p>
            </div>
        </div>
        <div class="infobox-accent">
            <div class="m-4">
                <x-icon class="text-lime-600" icon="sun-2" width="45" height="45" viewBox="0 0 45 45"
                    fill="currentColor" xmlns="http://www.w3.org/2000/svg"></x-icon>
                <h3 class="font-bold mt-2">Sunbathing</h3>
                <p class="mt-2">Take advantage of morning sunlight to stimulate the production of Vitamin D, an essential
                    nutrient that supports immune function and maintains bone density.
                    A brief exposure to gentle sunlight has also been shown to improve your overall mood and reduce the risk
                    of depression.</p>
            </div>
        </div>
        <div class="infobox-accent">
            <div class="m-4">
                <x-icon class="text-lime-600" icon="cycling" width="45" height="45" viewBox="0 0 45 45"
                    fill="currentColor" xmlns="http://www.w3.org/2000/svg"></x-icon>
                ...
                <p class="mt-2">Experience the freedom of pedaling through green paths and surrounding neighborhoods.
                    Cycling is an excellent low-impact exercise for building leg strength, increasing lung capacity, and is
                    a fun way to explore new areas.</p>
            </div>
        </div>
        <div class="infobox-accent">
            <div class="m-4">
                <x-icon class="text-lime-600" icon="basket" width="45" height="45" viewBox="0 0 45 45"
                    fill="currentColor" xmlns="http://www.w3.org/2000/svg"></x-icon>
                <h3 class="font-bold mt-2">Family Picnic</h3>
                <p class="mt-2">Put your gadgets aside and spend unforgettable time with your loved ones. Prepare your
                    favorite food and enjoy a delicious meal in the park or by the lake, making it the perfect opportunity
                    to bond with your family while breathing in the fresh air.</p>
            </div>
        </div>
    </div>
    <div class="flex justify-center mt-5 mb-6">
        <div class="infobox-accent max-w-1/2 flex-col">
            <div class="m-4">
                <x-icon class="text-lime-600" icon="yoga" width="45" height="45" viewBox="0 0 45 45"
                    fill="currentColor" xmlns="http://www.w3.org/2000/svg"></x-icon>
                <h3 class="font-bold mt-2">Yoga</h3>
                <p class="mt-2">Focus your attention on harmonizing your breathing with gentle but purposeful body
                    movements. Regular yoga practice is ideal for increasing joint and muscle flexibility, relieving
                    physical tension caused by stress, and achieving a state of deep mental calm.</p>
            </div>
        </div>
    </div>
    <!--Isi Activity-->
