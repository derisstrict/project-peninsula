...
<div class="relative flex flex-col">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="/" class="btn-primary p-4">
            ...
            <span class="text-sm text-light-primary">Take me to Google Maps</span>
            <svg class="text-light-primary" width="16px" height="16px" viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
