...
@section('content')
    <div class="flex justify-center items-center">
        <div class="flex flex-col max-w-[100rem] w-full mt-30 mx-20">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex gap-2">
                        <a href="/" class="btn-primary">
                            <svg class="text-lime-600" width="16px" height="16px" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <img class="absolute top-40 right-0 rounded-xl outline-4 outline-lime-600/15" width="800"
    ...
    <div class="max-w-6xl mx-20">
        <div class="flex items-center justify-between">
            ...
            <button class="bg-gray-400 px-8 py-4 rounded-xl hover:bg-gray-500 transition flex items-center gap-2">
                ...
                <img width="20" height="20"
                    ...
                    alt="external-share-ui-anggara-basic-outline-anggara-putra" />
            </button>
        </div>
